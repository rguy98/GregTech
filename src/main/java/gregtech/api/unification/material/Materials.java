...
public class Materials {
     ...
     * Direct Elements
     */
    public static IngotMaterial Aluminium = new IngotMaterial(1, "aluminium", 0xA1CAEA, DULL, 2, of(), EXT2_METAL | GENERATE_SMALL_GEAR | GENERATE_ORE | GENERATE_RING | GENERATE_FRAME, Element.Al, 10.0F, 2.0f, 128, 1700);
    ...
    public static IngotMaterial Chrome = new IngotMaterial(16, "chrome", 0xE4D1D7, SHINY, 3, of(), EXT2_METAL | GENERATE_RING | GENERATE_ROTOR, Element.Cr, 12.0f, 3.0f, 512, 1700);
    public static IngotMaterial Cobalt = new IngotMaterial(17, "cobalt", 0x2471D5, METALLIC, 2, of(), GENERATE_ORE | STD_METAL, Element.Co, 10.0F, 3.0f, 256);
    ...
    public static IngotMaterial Iridium = new IngotMaterial(32, "iridium", 0x889692, DULL, 3, of(), GENERATE_ORE | EXT2_METAL | GENERATE_ORE | GENERATE_RING | GENERATE_ROTOR, Element.Ir, 7.0F, 3.0f, 2560, 2719);
    ...
    public static IngotMaterial Lithium = new IngotMaterial(36, "lithium", 0xD6D6D6, DULL, 2, of(), STD_METAL | GENERATE_ORE, Element.Li);
    ...
    public static IngotMaterial Nickel = new IngotMaterial(44, "nickel", 0xEEE988, METALLIC, 2, of(), STD_METAL | GENERATE_ORE | MORTAR_GRINDABLE | GENERATE_PLASMA, Element.Ni);
    ...
    public static IngotMaterial Osmium = new IngotMaterial(47, "osmium", 0xC2D6E2, METALLIC, 4, of(), GENERATE_ORE | EXT2_METAL | GENERATE_RING | GENERATE_ROTOR, Element.Os, 16.0F, 4.0f, 1280, 3306);
    public static FluidMaterial Oxygen = new FluidMaterial(48, "oxygen", 0x90AAEE, FLUID, of(), STATE_GAS | GENERATE_PLASMA, Element.O);
    public static IngotMaterial Palladium = new IngotMaterial(49, "palladium", 0xF07427, METALLIC, 2, of(), EXT2_METAL | GENERATE_ORE | GENERATE_FLUID_BLOCK, Element.Pd, 8.0f, 2.0f, 512, 1228);
    public static DustMaterial Phosphorus = new DustMaterial(50, "phosphorus", 0xC8C800, SAND, 2, of(), 0, Element.P);
    public static IngotMaterial Platinum = new IngotMaterial(51, "platinum", 0xC3F4FF, SHINY, 2, of(), EXT2_METAL | GENERATE_ORE | GENERATE_FLUID_BLOCK, Element.Pt);
    public static IngotMaterial Plutonium = new IngotMaterial(52, "plutonium", 0xFD801A, METALLIC, 3, of(), EXT_METAL, Element.Pu);
    ...
    public static IngotMaterial Samarium = new IngotMaterial(59, "samarium", 0xB88847, METALLIC, 2, of(), STD_METAL, Element.Sm, 1345);
    public static IngotMaterial Scandium = new IngotMaterial(60, "scandium", 0xC1AA75, METALLIC, 2, of(), STD_METAL, Element.Sc, 1814);
    ...
    public static IngotMaterial Titanium = new IngotMaterial(72, "titanium", 0xE3BCEC, METALLIC, 3, of(), EXT2_METAL | GENERATE_RING | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_LONG_ROD | GENERATE_SPRING | GENERATE_FRAME | GENERATE_DENSE, Element.Ti, 7.0F, 3.0f, 1600, 1941);
    public static FluidMaterial Tritium = new FluidMaterial(73, "tritium", 0xFF0000, METALLIC, of(), STATE_GAS, Element.T);
    public static IngotMaterial Tungsten = new IngotMaterial(74, "tungsten", 0x595F63, METALLIC, 3, of(), EXT2_METAL, Element.W, 7.0F, 3.0f, 2560, 3000);
    public static IngotMaterial Uranium = new IngotMaterial(75, "uranium", 0x9EB64C, METALLIC, 3, of(), STD_METAL | GENERATE_ORE, Element.U, 6.0F, 3.0f, 512);
    public static IngotMaterial Uranium235 = new IngotMaterial(76, "uranium235", 0x256712, SHINY, 3, of(), STD_METAL | GENERATE_ORE | GENERATE_ROD, Element.U_235, 6.0F, 3.0f, 512);
    public static IngotMaterial Vanadium = new IngotMaterial(77, "vanadium", 0x93919C, METALLIC, 2, of(), STD_METAL, Element.V, 2183);
    ...
    public static IngotMaterial Brass = new IngotMaterial(94, "brass", 0xD8AE58, METALLIC, 1, of(new MaterialStack(Zinc, 1), new MaterialStack(Copper, 3)), EXT2_METAL | MORTAR_GRINDABLE | GENERATE_RING, 8.0F, 3.0f, 152);
    ...
    public static IngotMaterial Invar = new IngotMaterial(126, "invar", 0x99A29B, METALLIC, 2, of(new MaterialStack(Iron, 2), new MaterialStack(Nickel, 1)), EXT2_METAL | MORTAR_GRINDABLE | GENERATE_RING | GENERATE_FRAME, 7.0F, 3.0f, 512);
    ...
    public static IngotMaterial Osmiridium = new IngotMaterial(207, "osmiridium", 0xE1C893, METALLIC, 3, of(new MaterialStack(Iridium, 3), new MaterialStack(Osmium, 1)), EXT2_METAL, null, 9.0F, 3.0f, 3152, 2500);
