...
public class CoverBehaviors {
    ...
    public static void init() {
        ...
        registerBehavior(3, new ResourceLocation(GTValues.MODID, "conveyor.ev"), MetaItems.CONVEYOR_MODULE_EV, (tile, side) -> new CoverConveyor(tile, side, GTValues.EV, 2 * 64));
        registerBehavior(4, new ResourceLocation(GTValues.MODID, "conveyor.iv"), MetaItems.CONVEYOR_MODULE_IV, (tile, side) -> new CoverConveyor(tile, side, GTValues.IV, 4 * 64));
        ...
        registerBehavior(7, new ResourceLocation(GTValues.MODID, "conveyor.uv"), MetaItems.CONVEYOR_MODULE_UV, (tile, side) -> new CoverConveyor(tile, side, GTValues.UV, 24 * 64));
        registerBehavior(8, new ResourceLocation(GTValues.MODID, "conveyor.max"), MetaItems.CONVEYOR_MODULE_MAX, (tile, side) -> new CoverConveyor(tile, side, GTValues.MAX, 32 * 64));
        ...
        registerBehavior(13, new ResourceLocation(GTValues.MODID, "robotic_arm.ev"), MetaItems.ROBOT_ARM_EV, (tile, side) -> new CoverRoboticArm(tile, side, GTValues.EV, 2 * 64));
        registerBehavior(14, new ResourceLocation(GTValues.MODID, "robotic_arm.iv"), MetaItems.ROBOT_ARM_IV, (tile, side) -> new CoverRoboticArm(tile, side, GTValues.IV, 4 * 64));
        ...
        registerBehavior(17, new ResourceLocation(GTValues.MODID, "robotic_arm.uv"), MetaItems.ROBOT_ARM_UV, (tile, side) -> new CoverRoboticArm(tile, side, GTValues.UV, 24 * 64));
        registerBehavior(18, new ResourceLocation(GTValues.MODID, "robotic_arm.max"), MetaItems.ROBOT_ARM_MAX, (tile, side) -> new CoverRoboticArm(tile, side, GTValues.MAX, 32 * 64));
